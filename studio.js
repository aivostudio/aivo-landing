...
function startRecordingUI() {
  ...
  // FIXME: Buraya gerçek mikrofon kaydını başlatan fonksiyonlarını bağlayabilirsin.
  ...
  recordInterval = setInterval(() => {
    ...
    if (recordingProgressBar) recordingProgressBar.style.width = percent + "%";
...
function stopRecordingUI(autoByLimit = false) {
  ...
  // Gerçek kaydı durdurma yeri:
  // stopMicrophoneRecording();

  // Otomatik limitten değil de kullanıcı durdurduysa sonucu göster
